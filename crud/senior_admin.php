...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="senior_admin.php">Senior Pets</a>
      </li>
      <li class="nav-item">
...
<div class="hero d-flex justify-content-center w-100"><p class="m-auto"><b>Your pet adoption around the corner!</b></p></div>
  ...
  <h1 class="w-100 my-5 text-center">Senior Pets</h1>

            <?php
           $sql = "select id, image, name, description, TIMESTAMPDIFF(year, birthdate, current_date()) as age, type, hobbys, ZIP, city, address from pets join location on location=location_id where TIMESTAMPDIFF(year, birthdate, current_date())>7";
