...
<fieldset>
   ...
   <form action="actions/a_update.php"  method="post">
       <table>
           ...
           <tr>
               <th>Image</th>
               <td><input  type="text" name= "image" placeholder="Title" value="<?php echo $data['image'] ?>"></td>
           </tr>
           <tr>
               <th>Description</th>
          ...
          <tr>
               <th>Date of Birth</th>
               <td><input type="text"  name="birthdate" placeholder ="birthdate" value="<?php echo $data['birthdate'] ?>"></td>
           </tr>
                     <tr>
               <th>Hobbys</th>
               <td><input type="text"  name="hobbys" placeholder ="hobbys" value="<?php echo $data['hobbys'] ?>"></td>
           </tr>
           <tr>
               <th>Size</th>
               <td>
                 <select name="type">
                    <option value="small" <?php if ($data['type']=='small'){echo 'selected';} ?>>Small</option>
                    <option value="large" <?php if ($data['type']=='large'){echo 'selected';} ?>>Large</option>
                  </select>
               </td>
              </tr>
              <tr>
              ...
              <td>
                ...
                while($row = $result->fetch_assoc()) {
                  if ($data['location']==$row['location_id']){
                    echo "<option value='".$row['location_id']."' selected>".$row['ZIP']." ".$row['city'].", ".$row['address']."</option>";
                  } else {
           ...
           <tr>
               ...
               <td><button  type= "submit" class='btn btn-outline-warning'>Save Changes</button ><a  href= "index_admin.php"><button  type="button" class='btn btn-outline-success'>Back</button></a ></td>
               <td></td >
           </tr>
       </table>
   </form >
